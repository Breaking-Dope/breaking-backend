...
public class PostService {
    ...
    private PostType confirmPostType(String requestPostType) {
        ...
        if (PostType.EXCLUSIVE.getTitle().equals(requestPostType) || PostType.EXCLUSIVE.getTitle().toLowerCase().equals(requestPostType)) {
            postType = PostType.EXCLUSIVE;
        } else if (PostType.CHARGED.getTitle().equals(requestPostType) || PostType.CHARGED.getTitle().toLowerCase().equals(requestPostType)) {
            postType = PostType.CHARGED;
        } else if (PostType.FREE.getTitle().equals(requestPostType) || PostType.FREE.getTitle().toLowerCase().equals(requestPostType)) {
