...
class FeedSearchServiceTest {
    ...
    void get10postsWithoutFilter() {
        ...
        Page<FeedResultPostDto> paginationResult1 = searchFeedService.searchFeedPagination(searchFeedConditionDto, pageable1);
        List<FeedResultPostDto> content1 = paginationResult1.getContent();

        Page<FeedResultPostDto> paginationResult2 = searchFeedService.searchFeedPagination(searchFeedConditionDto, pageable2);
        List<FeedResultPostDto> content2 = paginationResult2.getContent();

        Page<FeedResultPostDto> paginationResult3 = searchFeedService.searchFeedPagination(searchFeedConditionDto, pageable3);
    ...
    void whenThereAreNoPosts() {
        ...
        Page<FeedResultPostDto> paginationResult = searchFeedService.searchFeedPagination(searchFeedConditionDto, pageable);
